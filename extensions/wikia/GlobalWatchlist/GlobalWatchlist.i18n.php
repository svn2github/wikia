...
Dies ist eine Liste aller Seiten auf deiner Wikia-Beobachtungsliste, die seit deinem letzten Besuch bearbeitet wurden.
...
Esta é unha lista de páxinas de blogue da súa lista de vixilancia de Wikia que foron editadas ou comentadas desde a súa última visita.

$3

Visite e edite a miúdo...

Wikia

* Para modificar as súas preferencias de notificacións sobre a lista de vixilancia, por favor, visite http://www.wikia.com/wiki/Special:Preferences
* Para marcar como visitadas todas as páxinas deste boletín semanal, consulte a opción na lapela "Lista de vixilancia" na páxina das súas preferencias',
	'globalwatchlist-blog-page-title-comment' => '$1 ($2 {{PLURAL:$2|comentario|comentarios}})',
...
$messages['ja'] = array(
	...
	'globalwatchlist-digest-email-subject' => 'ウォッチリスト週間報告',
	'globalwatchlist-digest-email-body' => '$1さん、

あなたがウォッチリストに入れていて、最後に閲覧してから編集が行われたページは以下の通りです。

$2

あなたがウォッチリストに入れていて、最後に閲覧してから編集やコメントが行われたブログページは以下の通りです。

$3

Wikia

* ウォッチリスト通知についての設定の変更は http://www.wikia.com/wiki/Special:Preferences で行えます。
* この週間報告に掲載されている全てのページを訪問済みにマークするには、個人設定ページにある"ウォッチリスト"タブのオプションを設定してください。',
...
Dit is een lijst met pagina\'s op uw volglijst bij Wikia die zijn bewerkt sinds u ze hebt bezocht.

$2

Dit is een lijst met blogpagina\'s op uw volglijst bij Wikia die zijn bewerkt of waar reacties bij zijn geplaatst sinds u ze hebt bezocht.
...
$messages['pms'] = array(
	...
	'globalwatchlist-digest-email-subject' => 'Resumé dla sman-a',
	'globalwatchlist-digest-email-body' => "Car \$1,

Costa-sì a l'é na lista ëd pàgine an soa lista ëd lòn ch'a ten sot euj ëd Wikia che a l'é stàita modificà da quand a l'ha visitala për ùltim.

\$2


Costa-sì a l'é na lista ëd pàgine djë scartari an soa lista ëd lòn ch'a ten sot euj ëd Wikia che a l'é stàita modificà o comentà da quand a l'has visitala për ùltim.

\$3

Për piasì ch'a vìsita e a modìfica pi 'd soens...

Wikia

* Për cangé soe preferense për la notìfica ëd la lista ëd lòn ch'a ten sot euj, për piasì ch'a vìsita http://www.wikia.com/wiki/Special:Preferences
* Për marché tute le pàgine da sò Resumé dla sman-a com visità, ch'a varda l'opsion ant la \"Lista ëd lòn ch'im ten-o sot euj\" ëd la pàgina dij sò gust",
...
Essa é uma lista de páginas de blog na sua lista de vigiados do Wikia que foram editadas ou comentadas desde sua última visita.

$3

Por favor, visite-as ou mesmo as edite...
...
Ово је списак страница на списку надгледања које су измењене од ваше последње посете.

$2


Ово је списак блог страница на списку надгледања које су измењене или прокоментарисане од ваше последње посете.

$3

Посећујте нас и уређујте чешће...

Викија

* Да бисте променили своје поставке о обавештавању, посетите http://www.wikia.com/wiki/Special:Preferences
* Да бисте означили све странице овог недељног прегледа као погледане, користите опцију у језичку „Списак надгледања“ странице за подешавање',
	'globalwatchlist-blog-page-title-comment' => '$1 ($2 {{PLURAL:$2|коментар|коментара|коментара}})',
